...
# Define batch size
batch_size = 1  # Adjust based on memory, using a larger batch size

# Create tf.data dataset
test_dataset, total_test_subjects = tf_data_generator(subjects, labels, batch_size)

# Load the trained model
model = load_model('3dcnnlstm.h5', custom_objects={'Conv4D': Conv4D})

# Clear TensorFlow session to avoid any memory issues
