...
def regress_out_confounds(fmri_data, confound_file):
    ...
    confound_columns = ['WhiteMatter', 'GlobalSignal', 'stdDVARS', 'non-stdDVARS', 'vx-wisestdDVARS',
                        'FramewiseDisplacement', 'tCompCor00', 'tCompCor01', 'tCompCor02', 'tCompCor03',
                        'tCompCor04', 'tCompCor05', 'aCompCor00', 'aCompCor01', 'aCompCor02', 'aCompCor03',
...
output_dir = '/home/orion/Geo/UCLA data/FMRIPrep/Applied Brain Mask & Regressed out confounds_vol2/'
